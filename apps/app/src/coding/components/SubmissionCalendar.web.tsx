...
const FILL = ['#ffffff', '#ccfbf1', '#5eead4', '#0d9488', '#115e59'];
const INK = ['#0f172a', '#115e59', '#134e4a', '#ffffff', '#ffffff'];
const TIP_W = 280;
...
.cal-kicker { margin:0; font-size:11px; font-weight:800; letter-spacing:.12em; text-transform:uppercase; color:#0f766e; }
.cal h2 { margin:.25rem 0 0; font-size:1.05rem; color:#0f172a; }
.cal-nav { display:flex; align-items:center; gap:.5rem; }
.cal-nav button { width:1.75rem; height:1.75rem; border-radius:999px; border:1px solid #e2e8f0; background:#f8fafc; cursor:pointer; }
.cal-nav button:hover { background:#ecfeff; }
...
.cal-kpis strong { font-size:1.15rem; color:#0f172a; }
...
.cal-day:hover { outline: 2px solid #0f172a; outline-offset: 0; z-index: 1; }
...
.cal-tip { position:fixed; z-index:80; width:280px; margin-left:-140px; background:#0f172a; color:#e2e8f0; padding:.7rem .8rem; border-radius:.7rem; pointer-events:none; box-shadow:0 12px 30px rgba(15,23,42,.28); }
.cal-tip-above { transform: translateY(-100%); }
.cal-tip p { margin:.22rem 0 0; font-size:.78rem; line-height:1.4; }
.cal-tip-date { margin:0 !important; color:#67e8f9; font-weight:700; font-size:.75rem !important; }
