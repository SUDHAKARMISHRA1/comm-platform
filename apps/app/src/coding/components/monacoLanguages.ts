...
export function setupMonacoLanguages(monaco: Monaco) {
  ...
  monaco.editor.defineTheme('comm-light', {
    ...
    rules: [
      ...
      { token: 'keyword', foreground: '0b1f3a', fontStyle: 'bold' },
      { token: 'string', foreground: '1e4a7a' },
      { token: 'number', foreground: 'b45309' },
      { token: 'type', foreground: '1e4a7a' },
      { token: 'identifier', foreground: '0b1f3a' },
      { token: 'delimiter', foreground: '334155' },
    ],
    colors: {
      'editor.background': '#ffffff',
      'editor.foreground': '#0b1f3a',
      'editorLineNumber.foreground': '#94a3b8',
      'editorLineNumber.activeForeground': '#0b1f3a',
      'editorCursor.foreground': '#0b1f3a',
      'editor.selectionBackground': '#e8eef699',
      'editor.inactiveSelectionBackground': '#e2e8f0',
      'editor.lineHighlightBackground': '#f4f6f9',
      'editorSuggestWidget.background': '#ffffff',
      'editorSuggestWidget.border': '#d5dde8',
