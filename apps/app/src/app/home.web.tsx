...
const homeCss = `
.cp-home { background:#ffffff; color:#0b1f3a; min-height:100%; width:100%; box-sizing:border-box; }
...
.cp-hero-glow { position:absolute; inset:0 0 auto; height:34rem; z-index:-1; pointer-events:none;
  background: radial-gradient(circle at 75% 0%, rgba(232,238,246,.95), transparent 32%),
              radial-gradient(circle at 15% 20%, rgba(30,74,122,.12), transparent 31%); }
...
.cp-pill { display:inline-flex; align-items:center; gap:.5rem; border:1px solid #d5dde8; background:#e8eef6;
  padding:.35rem .75rem; border-radius:999px; font-size:11px; font-weight:700; letter-spacing:.08em; color:#0b1f3a; box-shadow:0 1px 2px rgba(11,31,58,.06); }
.cp-pill-dot { width:6px; height:6px; border-radius:99px; background:#0b1f3a; }
.cp-copy h1 { margin:1.25rem 0 0; font-size:clamp(2rem,4vw,3.6rem); line-height:1.08; letter-spacing:-.045em; font-weight:650; color:#0b1f3a; }
.cp-lead { margin:1.25rem 0 0; max-width:36rem; font-size:1.125rem; line-height:1.8; color:#5a6b82; }
.cp-actions { margin-top:2rem; display:flex; flex-wrap:wrap; gap:.75rem; }
.cp-btn-dark { display:inline-flex; height:3rem; align-items:center; justify-content:center; border-radius:.6rem; background:#0b1f3a; color:#fff; padding:0 1.25rem; font-size:.875rem; font-weight:700; text-decoration:none; box-shadow:0 10px 24px rgba(11,31,58,.12); }
.cp-btn-dark:hover { background:#1e4a7a; transform:translateY(-1px); }
.cp-btn-light { display:inline-flex; height:3rem; align-items:center; justify-content:center; border-radius:.6rem; border:1px solid #0b1f3a; background:#0b1f3a; color:#fff; padding:0 1.25rem; font-size:.875rem; font-weight:700; text-decoration:none; }
.cp-btn-light:hover { background:#1e4a7a; border-color:#1e4a7a; }
.cp-fine { margin-top:1.1rem; font-size:.875rem; color:#5a6b82; }
.cp-preview-wrap { border-radius:1.1rem; border:1px solid #d5dde8; background:#fff; padding:.75rem; box-shadow:0 30px 60px rgba(11,31,58,.12); }
.cp-preview { border-radius:.9rem; border:1px solid #d5dde8; background:#f4f6f9; padding:1.15rem; }
.cp-preview-head { display:flex; align-items:center; justify-content:space-between; }
.cp-kicker { margin:0; font-size:11px; font-weight:700; letter-spacing:.08em; text-transform:uppercase; color:#5a6b82; }
.cp-preview h2 { margin:.2rem 0 0; font-size:1.15rem; font-weight:700; }
.cp-avatar { width:2.5rem; height:2.5rem; border-radius:999px; background:#0b1f3a; color:#fff; display:grid; place-items:center; font-weight:700; font-size:.875rem; }
.cp-workspace { margin-top:1.4rem; border-radius:.9rem; background:#fff; padding:1rem; box-shadow:0 1px 2px rgba(11,31,58,.05); border:1px solid #d5dde8; }
...
.cp-subtle { margin:.25rem 0 0; font-size:.75rem; color:#5a6b82; }
.cp-live { border-radius:999px; background:#dcfce7; color:#15803d; padding:.2rem .65rem; font-size:.75rem; font-weight:700; }
.cp-progress { margin-top:1rem; height:8px; overflow:hidden; border-radius:999px; background:#d5dde8; }
.cp-progress-fill { height:100%; width:75%; border-radius:999px; background:#16a34a; }
...
.cp-time { font-size:.75rem; color:#5a6b82; flex-shrink:0; }
.cp-updates { border-top:1px solid #d5dde8; border-bottom:1px solid #d5dde8; background:#fff; }
...
.cp-section-label { margin:0; font-size:.875rem; font-weight:700; color:#0b1f3a; }
...
.cp-card { border-radius:.9rem; border:1px solid #d5dde8; background:#f4f6f9; padding:1.5rem; transition:transform .15s ease, box-shadow .15s ease, border-color .15s ease, background .15s ease; }
.cp-card:hover { transform:translateY(-4px); border-color:#1e4a7a; background:#fff; box-shadow:0 16px 32px rgba(11,31,58,.12); }
.cp-card-index { display:grid; width:2.25rem; height:2.25rem; place-items:center; border-radius:.6rem; background:#0b1f3a; color:#fff; font-size:.875rem; font-weight:700; }
.cp-card h3 { margin:1.2rem 0 0; font-size:1.1rem; }
.cp-card p { margin:.5rem 0 0; font-size:.9rem; line-height:1.6; color:#5a6b82; }
.cp-cta-wrap { max-width:80rem; margin:0 auto; padding:4rem 1.25rem; }
.cp-cta { border-radius:1.1rem; background:#0b1f3a; padding:3rem 1.5rem; text-align:center; color:#fff; }
.cp-cta-label { margin:0; font-size:.875rem; font-weight:700; color:#fff; }
.cp-cta h2 { margin:.75rem auto 0; max-width:36rem; font-size:clamp(1.7rem,3vw,2.25rem); }
.cp-cta p { margin:1rem auto 0; max-width:32rem; color:#d5dde8; line-height:1.7; }
.cp-btn-navy { margin-top:1.75rem; display:inline-flex; height:2.75rem; align-items:center; justify-content:center; border-radius:.6rem; background:#1e4a7a; color:#fff; padding:0 1.25rem; font-size:.875rem; font-weight:700; text-decoration:none; }
.cp-btn-navy:hover { background:#255896; }
`;
